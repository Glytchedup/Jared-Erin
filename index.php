        ...
        <section class="home_intro  parallax2" data-image="img/Zoo.jpg">
            ...
            <div class="home_txt" data-0="opacity:1" data-top-bottom="opacity:0">
                ...
                <div class="box">
                    ...
                    <div class="title1"><span>Sept 21</span></div>
                    <div class="title0">2019</div>
                </div>
        ...
        <section class="married clearfix" id="married">
            <div class="container">
                ...
                <div class="married_txt" data-bottom="opacity:0" data-center="opacity:1">
                    ...
                    On the 21st of Sept, 2019<br>
                    <b> Jared Peterson &amp; Erin Kuboshige</b><br>
                    are getting married in Gilbert, AZ.<br>
        ...
        <section class="when_where white_txt parallax" id="when_where" data-image="img/Schnepf.jpg"
            ...
            <div class="container">
                ...
                <div class="when_where_container opacity">
                    ...
                    <div class="title1">Big Red Barn</div>
...
<div class="story_plane">
    ...
    <div class="story_txt">
        ...
        <div class="title3"><a class="maplink" href="https://www.amazon.com/wedding/share/ErAndJarBear" target="_blank">
                                    ...
                                    <i class="flaticon-gift30"></i></a></div>
                        </div>
                    </div>
                </div>
                <div class="story_item">
                    ...
                    <div class="paper">
                        ...
                        <div id="div_block_1">
                            <form id="rsvp_form"  action="" method="POST">
                                <div class="txt_input">
                                    <input name="name" type="text" id="name_block_1" class="form-control" placeholder="Your Name">
                                </div>
                                <div class="txt_input">
                                    <input name="guest" type="text" id="guest_block_1" class="form-control" placeholder="Your Guest's Name">
                                </div>
                                <div class="txt_input">
                                    <input name="email" type="email" id="email_block_1" class="form-control" placeholder="Your E-mail">
                                </div>
                                <div class="txt_input">
                                    <input name="attending" type="text" id="attending_block_1" class="form-control" placeholder="# Attending">
                                </div>
                                <input name="send" type="submit" value="Send" class="btn btn-lg submit_block_1">

                            </form>

                            <!-- Form Additional text -->
                            <p>We’re excited to see you! Any questions, just email us at:
                                <a href="mailto:erinkuboshige@gmail.com">erinkuboshige@gmail.com</a></p>
                        </div>
                    </div>
        ...
        <!-- Gallery End -->
        <!-- Footer -->
        <section class="footer white_txt parallax" id="footer" data-image="img/footer3.png">
            <div class="over"></div>
            <div class="container">
        ...
        <script type="text/javascript"
            src="https://cdnjs.cloudflare.com/ajax/libs/jquery-countdown/2.0.2/jquery.plugin.min.js"></script>
        <script type="text/javascript"
            src="https://cdnjs.cloudflare.com/ajax/libs/jquery-countdown/2.0.2/jquery.countdown.min.js"></script>
